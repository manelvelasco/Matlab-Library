...
MODEL                  = nodes4
MODULES                = nodes4_capi.c nodes4_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c 
MAKEFILE               = nodes4.mk
MATLAB_ROOT            = /Applications/MATLAB_R2014a.app
ALT_MATLAB_ROOT        = /Applications/MATLAB_R2014a.app
MATLAB_ROOTQ           = \"/Applications/MATLAB_R2014a.app\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /Users/mvelasco/CloudStation/vilanova/LIB_tt
S_FUNCTIONS            = rtiostream_utils.c ttkernelMATLAB.cpp ttnetwork.cpp
S_FUNCTIONS_LIB        = 
COMPUTER               = MACI64
BUILDARGS              =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/Applications/MATLAB_R2014a.app" EXT_MODE=1 OPTS="-DON_TARGET_WAIT_FOR_START=0"
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/raccel/nodes4 \
	-I$(START_DIR) \
	-I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils \
	-I$(MATLAB_ROOT)/toolbox/truetime-2.0-beta7/kernel \
...
%.o : $(MATLAB_ROOT)/toolbox/truetime-2.0-beta7/kernel/%.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
...
%.o : $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/%.cpp
	$(CPP) -c $(CPPFLAGS) "$<"
%.o : $(MATLAB_ROOT)/toolbox/truetime-2.0-beta7/kernel/%.cpp
	$(CPP) -c $(CPPFLAGS) "$<"
